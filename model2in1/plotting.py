...
def gene_coverage_plot(read_size, full_data, gene_range='./regions.bed', tb_drug_resistance_genes= tb_drug_resistance_genes, output_path = '.'):

    gene_range = pd.read_csv(gene_range, sep = '\t', header = 0)
    ...
    for g in tb_drug_resistance_genes:
        ...
        ax1.set_ylim([-len(amplicon_positions)-7, 100])
